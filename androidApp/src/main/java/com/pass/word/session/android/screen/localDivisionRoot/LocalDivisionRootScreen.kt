package com.pass.word.session.android.screen.localDivisionRoot
...
import com.pass.word.session.android.screen.mainApp.bottomScreen.bottomLocal.BottomMainScreen
...
fun LocalDivisionRootScreen(component: LocalDivisionRootComponent) {
    ...
    Children(
        ...
        when (val instance = child.instance) {
            ...
            is LocalDivisionRootComponent.Child.ScreenBottomLocal -> BottomMainScreen(component = instance.component)
