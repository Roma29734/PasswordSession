...
@Composable
fun ChangePasswordScreen(component: ScreenChangePasswordComponent) {
    ...
    Column(
        ...
        Row(
            ...
            ButtonNumber(1) {
                component.onEvent(ChangePasswordEvent.StateUpdatePassItem(it))
            }
            ButtonNumber(2) {
                component.onEvent(
                    ChangePasswordEvent.StateUpdatePassItem(
                        it
                    )
                )
            }
