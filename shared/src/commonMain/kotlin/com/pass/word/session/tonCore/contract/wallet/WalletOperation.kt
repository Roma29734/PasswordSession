...
class WalletOperation {
    ...
    private fun getWallet(): WalletV4R2 {
        return runBlocking {
            ...
            val t = listOf(
                "alert", "grain", "ethics", "drum", "surge", "vocal", "nation", "empower", "canyon", "guitar", "project", "diet",
                "field", "afford", "stumble", "joy", "solve", "inform", "amused", "angle","fantasy", "move", "transfer", "actress"
            )

            val keyPair = Mnemonic.toKeyPair(t)
    ...
    fun getWalletAddress() {
        runBlocking(Dispatchers.IO){
            ...
            println("walllet address -" + wallet.address.toAddrString())
        }
    }
}
