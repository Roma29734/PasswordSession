...
public val MyIconPack.IcImport: ImageVector
    get() {
        if (_icImport != null) {
            return _icImport!!
        }
        _icImport = Builder(name = "IcImport", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _icImport: ImageVector? = null
