...
public val MyIconPack.IcCopySourse: ImageVector
    get() {
        if (_icCopySourse != null) {
            return _icCopySourse!!
        }
        _icCopySourse = Builder(name = "IcCopySourse", defaultWidth = 24.0.dp, defaultHeight =
...
private var _icCopySourse: ImageVector? = null
